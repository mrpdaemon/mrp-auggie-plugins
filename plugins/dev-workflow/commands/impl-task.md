...
If none of the optional files are available, you will perform your own codebase exploration as needed during implementation. Use `codebase-retrieval` and `mrp-explorer` (or `sub-agent-mrp-explorer`, whichever is available) agents to explore the codebase.
...
- If none of the optional files are available, explore the codebase yourself using `codebase-retrieval` and `mrp-explorer` (or `sub-agent-mrp-explorer`, whichever is available) agents before implementing.
