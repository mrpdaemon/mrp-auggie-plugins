...
## Step 3: Populate task.md

The target file is `/home/augment/.augment/tasks/{task_name}/task.md`.

First, check whether the file already exists:
```
test -f /home/augment/.augment/tasks/{task_name}/task.md && echo EXISTS || echo NEW
```
...
```
vim /home/augment/.augment/tasks/{task_name}/task.md
```
Then wait for the user to confirm they are done editing before proceeding to Step 4.
